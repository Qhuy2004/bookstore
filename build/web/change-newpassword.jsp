                                        ...
                                        <form class="mx-1 mx-md-4" action="forgetPassword" method="post">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text" placeholder="Tên người dùng" id="form3Example1c" class="form-control" required name="user"/>
                                                </div>
                                            </div>
                                            <!--                                            <div class="d-flex flex-row align-items-center mb-4">
                                                                                            <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="password" placeholder="Mật khẩu mới" id="form3Example1c" class="form-control" required name="newPassword"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="password" placeholder="Xác nhận mật khẩu" id="form3Example3c" class="form-control" required name="confirmPassword"/>
                                                </div>
                                            </div>
